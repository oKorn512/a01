...
void trace_photons(const Context& context, uint32_t N, std::vector<PathVertex>& photons, bool scale_photon_power) {
    throw std::runtime_error("Function not implemented: " + std::string(__FILE__) + ", line: " + std::to_string(__LINE__));
}

void trace_photons_caustics(const Context& context, uint32_t N, std::vector<PathVertex>& photons, bool scale_photon_power) {
    throw std::runtime_error("Function not implemented: " + std::string(__FILE__) + ", line: " + std::to_string(__LINE__));
}
